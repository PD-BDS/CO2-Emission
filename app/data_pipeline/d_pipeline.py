...
import logging
from data_pipeline.db_operation import get_last_date_from_db, store_to_db
from data_pipeline.data_fetcher import fetch_data
from data_pipeline.data_processor import process_and_aggregate
from data_pipeline.feature_engineering import add_features
...
def run_pipeline():
    try:
        ...
        if not aggregated_df.empty and not features_df.empty:
            ...
            aggregated_df.to_csv("app/database/aggregated_hourly_data.csv", index=False)
