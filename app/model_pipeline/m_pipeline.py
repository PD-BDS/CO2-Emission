...
from model_pipeline.data_utils import load_data, create_sequences
from model_pipeline.trainer import train_model
from model_pipeline.evaluator import evaluate_model
from model_pipeline.logger import log_to_database
from model_pipeline.model_definitions import AttentionLSTMModel

# Setup logging
logging.basicConfig(
    filename='app/logs/training_pipeline.log',
    level=logging.INFO,
...
MODEL_PATH = f"app/models/{MODEL_NAME}_{VERSION}_{timestamp}.pth"
...
if __name__ == "__main__":
    ...
    joblib.dump(scaler_x, "app/models/scaler_x.pkl")
    joblib.dump(scaler_y, "app/models/scaler_y.pkl")
