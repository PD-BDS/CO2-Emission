...
from scripts.prediction_pipeline.predictor import run_prediction_pipeline, get_best_model_info
from scripts.prediction_pipeline.retrainer import retrain_model

RETRAIN_THRESHOLD = 65.0

logging.basicConfig(filename="logs/prediction_pipeline.log", level=logging.INFO)
