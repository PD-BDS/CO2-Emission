...
conn = sqlite3.connect("database/co2_emission.db")
cursor = conn.cursor()
...
# 4. Create Model Training Set Table (model_id x time_frame mapping)
cursor.execute('''
...
# 5. Create Predictions Table (with model drift score)
cursor.execute('''
...
print("✅ Database schema created in 'database/co2_emission.db'")
